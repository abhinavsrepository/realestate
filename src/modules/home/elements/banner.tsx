    ...
    <div className="bg-[#f7f5ff] h-[95vh]">
      ...
      <div className="w-full h-full flex justify-center items-center relative overflow-hidden">
        ...
        <div className="absolute">
          <h1 className="font-clashDisplay uppercase font-bold text-cyber-ink text-[2.75rem] md:text-[4xl] lg:text-[4rem] xl:text-[5.75rem] max-w-4xl mx-auto text-center z-10">
            NEWSLETTER PLATFORM  BUILT FOR BUSINESS BY
            <span className="font-style">IRIS DESIGN</span>
          </h1>
          <br />
          <h3 className="text-3xl text-center">Built by Iris for people</h3>
          <br />
